...
function PillAction({ icon: Icon, label, hint, index, onClick }) {
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.98 }}
      className="inline-flex items-center gap-2.5 bg-white rounded-full border border-neutral-200 shadow-sm px-5 py-3 text-[13px] font-medium text-neutral-900 hover:border-neutral-300 hover:shadow-md transition-all duration-200"
    >
  ...
  return (
    <div className="flex flex-wrap items-center justify-center gap-3">
      ...
      <motion.div
        ...
        className="inline-flex items-center gap-2.5 bg-neutral-50 rounded-full border border-neutral-200 px-5 py-3 text-[13px] font-medium text-neutral-600"
      >
