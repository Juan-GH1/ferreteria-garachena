...
export default function CatalogDownloads({ products }) {
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 pb-16">
      <p className="text-2xs uppercase tracking-[0.2em] text-neutral-400 font-medium text-center">Recursos Descargables</p>
      ...
      <p className="mt-2 text-13 text-neutral-500 text-center max-w-lg mx-auto">
        ...
        {available.map((cat, index) => {
          ...
          return (
            ...
            >
              ...
              <div>
                <h3 className="text-sm font-semibold tracking-tight text-neutral-900">{cat.label}</h3>
